...
![State-Space Model Setup](/Users/gcgibson/Desktop/ssm.png)
...
seasonal_model_file = '/Users/gcgibson/Stein-Variational-Gradient-Descent/bug_files/seasonal_pois.bug' # BUGS model filename
...
require(rbiips)
library(MCMCpack)
locally_level_model_file = '/Users/gcgibson/Stein-Variational-Gradient-Descent/bug_files/locally_level_1.bug' # BUGS model filename
...
for (i in 1:nrow(aggregate_forecast)){
  meanSsvgdForecasts <- c(meanSsvgdForecasts,mean(aggregate_forecast[i,]))
  varSsvgdForecasts <- c(varSsvgdForecasts,var(aggregate_forecast[i,]))
  srted <- sort(aggregate_forecast[i,])
  lowPiSsvgdForecasts <- c(lowPiSsvgdForecasts,srted[2])
  highPiSsvgdForecasts <- c(highPiSsvgdForecasts,srted[9])
}
